...
Also Galois theory gives a new sights of study of fields which is ``study of fields via study of its automorphisms'' which are permutations of the field.
\vspace{15mm}
That is,
\begin{minipage}{0.33\textwidth}
  \begin{tcolorbox}[colback=gray!20, colframe=blue!20, title={ \textcolor{red}{Structure of a Field \(F\)}}, width=5cm]
    \begin{tikzpicture}
      \hspace{10mm}
      \node[minimum width=7mm,
      minimum height=7mm,
      fill=brown!70] (f) {\large F};
  ...
  \end{minipage} \hrulefill
    \begin{minipage}{0.37\textwidth}
      \begin{tcolorbox}[colback=gray!20, colframe=blue!20, title={ \textcolor{red}{Structure of its symmetry}},  width=6cm]
        \begin{tikzpicture}
          \hspace{11mm}
      \node[minimum width=7mm,
      minimum height=7mm,
