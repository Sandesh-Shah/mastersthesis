Galois fields are the finite fields. They can be completely characterized in terms of splitting fields of some polynomials. It is found that the Galois group of an extension of a finite field by a finite field is cyclic. The Galois field with \(q\) elements is denoted by \(GF(q)\) \cite{hunger}.
...
\begin{tabular}{|c|c|c|}
    ...
    \hline
\end{tabular}
\caption{\footnotesize Binary representation table of field elements.}
\end{table}
\vspace{3mm}
