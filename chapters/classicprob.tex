...
\begin{definition}
The equation \(f(x)=0\) is \texit{solvable by radicals} if there exists a radical extenstion \(F\) of \(K\) and splitting field \(E\) of \(f\) over \(K\) such that \(F \superset E \superset \K\).
\end{definition}
